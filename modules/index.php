...
<section class="banner-section">
    ...
    <div class="book-btn"><a target="_blank"
            href="https://www.opentable.com.mx/restref/client/?restref=1011607&lang=es-MX&corrid=28e8fc3b-bf66-4d0c-b80d-44111890b98b"
            class="theme-btn"><span class="icon"><img src="images/resource/book-icon-1.png" alt="" title=""></span><span
                class="txt">Reserva ahora</span></a></div>
</section>
<!--End Banner Section -->
...
<section class="we-offer-section">
    ...
    <div class="auto-container">
        <div class="title-box centered">
            <div class="subtitle"><span>Exquisitos platillos</span></div>
            <div class="pattern-image"><img src="images/icons/separator.svg" alt="" title=""></div>
            <h2>Ofrecemos calidad y sabor</h2>
            <div class="text">
                Tienes que venir y probar de nuestros mejores platillos, que te envolverán en su delicioso sabor.
            </div>
        </div>
            ...
            <div class="text-col col-xl-5 col-lg-5 col-md-12 col-sm-12">
                <div class="inner wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                    ...
                    <div class="booking-info">
                        <div class="bk-title">Teléfono</div>
        ...
        <div class="row clearfix">
            ...
            <div class="why-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                    ...
                    <h4>El mejor ambiente</h4>
                    <div class="text">Disfrutar de una exquisita cena y un buen servicio es nuestra prioridad.</div>
                </div>
            </div>
            ...
            <div class="why-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                    ...
                    <div class="text">Entretenimiento con música en vivo en compañía de un delicioso platillo.</div>
                </div>
            </div>
            ...
            <div class="why-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="900ms">
                    ...
                    <h4>Promo Cumpleañeros</h4>
                    <div class="text">Reserva y decoramos tu mesa, postre de cortesía para el cumpleañero totalmente
                        gratis.</div>
                </div>
            </div>
        </div>
            ...
            <div class="content-col col-xl-6 col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                    <div class="title-box">
                        ...
                        <div class="subtitle"><span>Conócenos</span></div>
                        <div class="pattern-image"><img src="images/icons/separator.svg" alt="" title=""></div>
                    ...
                    <div class="link-box">
                        <a target="_blank"
                            href="https://www.opentable.com.mx/restref/client/?restref=1011607&lang=es-MX&corrid=5ff1238a-97a9-4776-a012-4517598542c7"
                            class="theme-btn btn-style-two clearfix">
                            <span class="btn-wrap">
                                <span class="text-one">Reservar</span>
                                <span class="text-two">Reservar</span>
                ...
                <div class="reserv-col col-lg-8 col-md-12 col-sm-12">
                    <div class="inner">
                        <div class="title">
                            ...
                            <div class="request-info">Booking request <a href="#">+88-123-123456</a> or fill out the
                                order form</div>
                        </div>
...
<section class="intro-section">
    ...
    <div class="auto-container">
        <div class="content-box">
            <div class="title-box centered">
                <div class="subtitle"><span>Experiencia inolvidable</span></div>
                <div class="pattern-image"><img src="images/icons/separator.svg" alt="" title=""></div>
            ...
            <div class="testi-top owl-theme owl-carousel">
                <div class="slide-item">
                    <div class="slide-content">
                        ...
                        <div class="text quote-text">
                            <strong> Familia feliz!</strong> <br>
                            Un excelente servicio, gracia a Leonardo por su agradable atención, todo muy rico! Sin duda
                            volveré!
                        </div>
                    </div>
                </div>
                ...
                <div class="slide-item">
                    <div class="slide-content">
                        <div class="quotes">”</div>
                        <div class="text quote-text">
                            We had Christmas dinner at Fiorenza, and oh my goodness it was incredible. The ambience was
                            wonderful; I ordered the Spaghetti Ai Gamberetti with homemade pasta. WOW! This is authentic
                            Italian at its finest. Great place. You won't be disappointed.
                        </div>
                    </div>
                </div>
                <div class="slide-item">
                    <div class="slide-content">
                        <div class="quotes">”</div>
                        <div class="text quote-text">
                            OMG.. twice in 2 weeks excellent both times. Service, presentation, ambience, just great.
                            Lasagna, homemade pasta noodles, sausage made in house, pizza. They really make sure it is a
                            beautiful experience. Will eat here weekly until we leave. Wish we had a place like this in
                            the states. Cheers x 10!!!!!!
                        </div>
                    </div>
                </div>
                <div class="slide-item">
                ...
                <div class="slide-item">
                    <div class="slide-content">
                        <div class="quotes">”</div>
                        <div class="text quote-text">
                            La comida muy buena, la atención excelente. Ambiente muy divertido !!!
                        </div>
                    </div>
                </div>
            </div>
